...
4. If mid is even, we check if nums[mid] != nums[mid+1]. If this is true, it means that the element at
index mid is the single element that occurs once. So we update high to mid-1.
