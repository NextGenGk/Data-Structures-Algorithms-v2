...
public class Trapping_Rainwater {
    ...
    public int trap(int[] height) {
        ...
        // Right [i] contains height of the tallest bar to
...
2. left[i] contains height of the tallest bar to the left of i'th bar including itself
3. Right [i] contains height of the tallest bar to the right of ith bar including itself
4. Initialize result
