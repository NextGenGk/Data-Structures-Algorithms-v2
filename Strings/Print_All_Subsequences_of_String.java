...
2. We recursively call the function with the string without the first character and the answer with the first character.
3. We recursively call the function with the string without the first character and the answer without the first character.
 */
